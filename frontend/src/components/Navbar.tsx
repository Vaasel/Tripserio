...
const Navbar = () => {
  return (
    <>
      <div className=" fixed w-full z-20 top-0 left-0 border-b border-gray-200 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            <button
              type="button"
              className="text-black bg-transparent border-solid border-3 focus:ring-4 focus:outline-none font-medium rounded-sm text-sm px-4 py-2 text-center mr-3 md:mr-0 border-gray-900 "
            >
              Login or Register
            </button>
            <button
          ...
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
              <li>
                <a
                  href="#"
                  className="block py-2 pl-3 pr-4 text-black bg-blue-700 rounded md:bg-transparent md:text-[#b73e6b]-700 md:p-0 md:dark:text-[#b73e6b]-500"
                  aria-current="page"
                >
                  Home
                </a>
              ...
              <li>
                <a
                  href="#"
                  className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#b73e6b]-700 md:p-0 md:dark:hover:text-[#b73e6b]-500 dark:text-black dark:hover:bg-gray-700 dark:hover:text-black md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Recommendations
                </a>
              </li>
